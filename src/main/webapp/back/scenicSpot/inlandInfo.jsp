        ...
        <c:forEach items="${pageInfo.list}" var="inland">
            <tr class="text-c">
                ...
                <td class="td-manage">
                    ...
                    <a title="编辑" href="javascript:;" onclick="inland_edit('国内线路编辑','back/scenicSpot/updateById/${inland.id}','900','650')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                    <a title="删除" href="javascript:;" onclick="inland_del(this,${inland.id})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
...
<script type="text/javascript">
    ...
    */
    ...
    /*国内线路-编辑*/
    function inland_edit(title,url,w,h){
