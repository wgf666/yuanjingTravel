...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 景点管理 <span class="c-gray en">&gt;</span> 境外线路 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
    <div class="text-c">
        <div class="row cl ">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:;" onclick="addForeign('添加新景点','back/scenicSpot/addScenicSpot1.jsp','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加新景点</a>
        </span>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#query").click(function(){
                ...
                $("#authorization").load("back/scenicSpot/getForeignList",{"id":type,"arrange":role});
                //选择的菜单
        ...
        /*添加境外景点*/
        function addForeign(title,url,w,h){
            location.href=url;
        }
