...
<link href="css/style.css" rel="stylesheet" type="text/css" />
    <title>后台管理 - H-ui.admin v2.3</title>
</head>
<body>
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="/">H-ui.admin</a> <a class="Hui-logo-m l" href="/" title="H-ui.admin">H-ui</a> <span class="Hui-subtitle l">V2.3</span>
    ...
    <ul class="Hui-userbar">
        <li>超级管理员</li>
        <li class="dropDown dropDown_hover"><a class="dropDown_A">${admin.name} <i class="Hui-iconfont">&#xe6d5;</i></a>
            <ul class="dropDown-menu radius box-shadow">
<%--                <li><a href="#">个人信息</a></li>--%>
                <li><a href="back/login.jsp">切换账户</a></li>
...
<%--        <dl id="menu-picture">--%>
<%--            <dt><i class="Hui-iconfont">&#xe62d;</i> <a href="">管理员管理</a><i class="Hui-iconfont menu_dropdown-arrow"><</i></dt>--%>
<%--        </dl>--%>

        <dl id="menu-picture">
            <dt>
                <i class="Hui-iconfont">&#xe62d;</i><a _href="back/user/getUserList" href="javascript:void(0)"> 用户管理</a>
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a _href="grogshop/getHotelList" href="javascript:void(0)">酒店信息管理</a></li>
                    <li><a _href="back/hotel/getList/1" href="javascript:void(0)">酒店订单管理</a></li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-page">
            ...
            <dd>
                <ul>
                    <li><a _href="back/air/getAirList" href="javascript:void(0)">航空公司管理</a></li>
                    <li><a _href="page-flinks.html" href="javascript:void(0)">机票订单管理</a></li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-comments">
            ...
            <dd>
                <ul>
                    <li><a _href="back/scenicSpot/getArrangeByInland" href="javascript:;">国内线路</a></li>
                    <li><a _href="back/scenicSpot/getArrangeByForeign" href="javascript:void(0)">境外线路</a></li>
                    <li><a _href="back/scenicSpot/orderList.jsp" href="javascript:;">订单列表</a></li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a _href="member-xxxxx.html" href="javascript:;">会员列表</a></li>
        ...
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    ...
                    <li><a _href="auth/showAuthPage" href="javascript:void(0)">授权管理</a></li>
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="back/welcome.jsp"></iframe>
        </div>
    </div>
</section>
