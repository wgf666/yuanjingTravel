        ...
        <div class="step" style="padding:5px;">
            ...
            <div class="body">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <th class="th_1">团购项目 </th>
                        <th class="th_2">出发时间 </th>
                        <th class="th_2">购买数量 </th>
                        <th class="th_3">总金额 </th>
                        <th class="th_4">订单状态 </th>
                        <th class="th_5">操作 </th>
                    </tr>
                    <c:forEach items="${pageInfo.list}" var="info">
                        <tr>
                            <td class="td_1">
                                <a class="line" href="scenicSpot/buy/${info.scenicId}">
                                    <img width="64" height="48" alt="" src=${info.scenicSpot.image} /><br /><span>${info.scenicSpot.scenicIntroduction}</span>
                                </a>
                            </td>
                            <td>
                                <fmt:formatDate value="${info.startTime}" pattern="yyyy-MM-dd HH:mm" />
                                <br>
                            ...
                            <td>
                                <div id="24110403-change">
                                    <c:if test="${info.state==0}"><a href="ScenicSpotOrder/tobaoming?uid=${info.uid}">未支付</a></c:if>
                                    <c:if test="${info.state==1}">等待审核</c:if>
                                    <c:if test="${info.state==2}">审核通过</c:if>
                                    <c:if test="${info.state==3}">订单被拒绝</c:if>
                                </div>
                            </td>
                            <td class="td_5">
                                <p id="24110403-details" class="detail">
                                    <a href="http://buy.ly333.com/order/handle/24110403">【查看详情】</a></p>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
