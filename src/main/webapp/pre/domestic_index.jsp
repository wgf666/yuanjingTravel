        ...
        <div class="Hot">
            <div class="Search">
                ...
                <div class="Inputbtn">
                    ...
                    <input type="text" id="special" name="special" class="input" value="请输入目的地名称或线路名称" onfocus="this.value=''">
...
<div class="Content">
    ...
    <div class="HotRecom">
        <div class="leftLoop">
            ...
            <div class="bd">
                <ul class="picList">
                    <c:forEach items="${china}" var="info">
                    <li>
    ...
    <div class="Index_left">
        <ul class="domesticlist">
            ...
            <c:forEach items="${TreeMap}" var="map">
                <c:set var="mapKey" value='${map.key}' />
                <li>
                    <h1><span><a href="scenicSpot/quyu?arrang=${map.key}">更多 >></a></span><em>${map.key}</em></h1>
                    <dl>
                        <c:forEach items="${map.value}" var="spot">
                        <dt>
                            <a href="scenicSpot/buy/${spot.id}"><img src=${spot.image} /></a>
                            <h2><a href="scenicSpot/buy/${spot.id}">${spot.scenicIntroduction}</a></h2>
                            <p><font>${spot.discount}</font> 元起</p>
